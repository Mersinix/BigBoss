...
export function useUpdatePrinterProfile() {
  ...
  return useMutation({
    mutationFn: (data: { description?: string; websiteUrl?: string | null; marketplaceVisible?: boolean; isOnVacation?: boolean; weeklyHours?: OpeningHoursMap; portfolioImages?: string[] }) =>
